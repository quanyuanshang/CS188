    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        livingGhostPositionDistributions = \
            [beliefs for i, beliefs in enumerate(self.ghostBeliefs)
             if livingGhosts[i+1]]
        "*** YOUR CODE HERE ***"
        # Step 1: Find the most likely position of each living ghost
        mostLikelyPositions = []
        ...
        for pos in mostLikelyPositions:
            ...
            if distance < minDistance:
                ...
                closestGhost = pos
        # Step 3: Choose the action that brings Pacman closest to the closest ghost
        ...
        for action in legal:
            ...
            if distance < minActionDistance:
                minActionDistance = distance
                bestAction = action
        return bestAction
